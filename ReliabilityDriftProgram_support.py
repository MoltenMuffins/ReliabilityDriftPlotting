...
def read_database(filepath):
    '''
    This function reads RTO-XXXX_[TestType]_Database.csv files generated by the build_database() functino.
    '''
...
def file_plot_interactive():
    ...
    for i in listoffiles:
        main_df = pd.read_csv(listoffiles[0])
        print(main_df)
        plotMPIdata(main_df)
...
def folder_save_img():
    ...
    for listoffiles in (FFTfiles, NFTfiles, LIVfiles):
        try:
